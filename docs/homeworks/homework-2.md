...
1. Склонируйте рабочий репозиторий нашего проекта [https://github.com/novillero/dac-4](https://github.com/novillero/dac-4){target=_blank}. 
...
7. Перейдите в [GitHub → Pull requests](https://github.com/novillero/dac-4/pulls){target=_blank} и создайте Pull Request из вашей рабочей ветки в ветку `master`.
...
??? note "Методика выполнения"
    ...
    1. Склонируйте репозиторий себе на устройство:
        ...
        ```
        git clone https://github.com/novillero/dac-4
        ```
    ...
    12. Откройте репозиторий в GitHub: [https://github.com/novillero/dac-4](https://github.com/novillero/dac-4){target=_blank}.
